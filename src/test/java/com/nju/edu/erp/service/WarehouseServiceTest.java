...
public class WarehouseServiceTest {
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTime_TimeError() throws ParseException { //测试查看一段时间内入库商品的数量,当开始时间大于结束时间时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTime_EmptyResult() throws ParseException { //测试查看一段时间内入库商品的数量,当指定时间段没有入库商品时，数量应为0
    ...
    @Transactional
    @Rollback
    public void getWarehouseInputProductQuantityByTime() throws ParseException { //测试查看一段时间内入库商品的数量,这段时间内有入库商品的情况
