...
//    }
    ...
    public void sale_promotion() {
        ...
        Assertions.assertNotNull(latestSheet);
        Assertions.assertEquals(realSheetId, latestSheet.getId());
        Assertions.assertEquals(0, latestSheet.getRawTotalAmount().compareTo(BigDecimal.valueOf(50000.00)));
        Assertions.assertEquals(0, latestSheet.getFinalAmount().compareTo(BigDecimal.valueOf(48450.00)));
        Assertions.assertEquals(SaleSheetState.PENDING_LEVEL_1, latestSheet.getState());
    }
    ...
    public void sale_promotion_2() {
        ...
        Assertions.assertNotNull(latestSheet);
        Assertions.assertEquals(realSheetId, latestSheet.getId());
        Assertions.assertEquals(0, latestSheet.getRawTotalAmount().compareTo(BigDecimal.valueOf(100000.00)));
        Assertions.assertEquals(0, latestSheet.getFinalAmount().compareTo(BigDecimal.valueOf(96950.00)));
        Assertions.assertEquals(SaleSheetState.PENDING_LEVEL_1, latestSheet.getState());
        ...
        content.sort(Comparator.comparing(SaleSheetContentPO::getPid));
        Assertions.assertEquals("0000000000400000", content.get(0).getPid());
        Assertions.assertEquals(0, content.get(0).getTotalPrice().compareTo(BigDecimal.valueOf(50000.00)));
    }
}
