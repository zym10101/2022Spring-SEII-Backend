...
public class WarehouseServiceImpl implements WarehouseService {
    ...
    @Override
    @Transactional
    public void productGiftOutOfWarehouse(WarehouseZSDPO warehouseZSDPO) {
        warehouseOutputSheetDao.saveGift(warehouseZSDPO);
    }
    ...
    @Override
    @Transactional
    public String getNewWarehouseZSDId() {
        return IdGenerator.generateSheetId(warehouseOutputSheetDao.getGiftLatest().getId(), "ZSD");
    }
    ...
    public int getWarehouseInputProductQuantityByTime(String beginDateStr, String endDateStr) {
        ...
        try {
            ...
            if (beginDate.before(endDate)) {
                inputQuantity = warehouseInputSheetDao.getWarehouseInputProductQuantityByTime
                        (beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
    ...
    public int getWarehouseOutProductQuantityByTime(String beginDateStr, String endDateStr) {
        ...
        try {
            ...
            endDate = sdf.parse(endDateStr);
            if (beginDate.before(endDate)) {
                OutputQuantity = warehouseOutputSheetDao.getWarehouseOutputProductQuantityByTime
                        (beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
    ...
    @Override
    public List<WarehouseSpecialIODetailPO> getWarehouseSpecialIODetailByTime(String beginDateStr, String endDateStr) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            Date beginTime = sdf.parse(beginDateStr);
            Date endTime = sdf.parse(endDateStr);
            if (beginTime.before(endTime)) {
                return warehouseInputSheetDao.getWarehouseSpecialIODetailByTime(beginTime, endTime);
            } else {
                return null;
            }
        } catch (ParseException e) {
    ...
    @Override
    public List<WarehouseZSDPO> getWarehousePresent() {
        return warehouseOutputSheetDao.getWarehousePresent();
    }

    @Override
    public List<WarehouseBYDPO> getWarehouseOverflow() {
        return warehouseDao.getAllOverflow();
    }

    @Override
    public int getOverflowByTime(String beginDateStr, String endDateStr) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        try {
            ...
            endDate = sdf.parse(endDateStr);
            if (beginDate.before(endDate)) {
                overflow = warehouseDao.getOverflowByTime(beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    @Override
    public List<WarehouseBSDPO> getWarehouseLoss() {
        return warehouseDao.getAllLoss();
    }

    @Override
    public int getLossByTime(String beginDateStr, String endDateStr) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date beginDate, endDate;
        int loss = 0;
        try {
            ...
            endDate = sdf.parse(endDateStr);
            if (beginDate.before(endDate)) {
                loss = warehouseDao.getLossByTime(beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    @Override
    public int getPresentByTime(String beginDateStr, String endDateStr) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date beginDate, endDate;
        int present = 0;
        try {
            ...
            endDate = sdf.parse(endDateStr);
            if (beginDate.before(endDate)) {
                present = warehouseDao.getPresentByTime(beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
        }
