...
public interface WarehouseService {
     ...
     * 商品赠送
     */
    void productGiftOutOfWarehouse(WarehouseZSDPO warehouseZSDPO);
     ...
     * @return
     */
    int getWarehouseInputProductQuantityByTime(String beginDateStr, String endDateStr) throws ParseException;
    ...
    /**
     * 库存查看：设定一个时间段，查看此时间段内的报溢单/报损单/赠送单信息
     *
     * @param beginDateStr 开始时间字符串
     * @param endDateStr   结束时间字符串
     * @return
     * @throws ParseException
     */
    List<WarehouseSpecialIODetailPO> getWarehouseSpecialIODetailByTime(String beginDateStr, String endDateStr) throws ParseException;
     ...
     * @return
     */
    List<WarehouseZSDPO> getWarehousePresent();
     ...
     * @return
     */
    List<WarehouseBYDPO> getWarehouseOverflow();
     ...
     * @return 报溢总额
     */
    int getOverflowByTime(String beginDateStr, String endDateStr);
     ...
     * @return
     */
    List<WarehouseBSDPO> getWarehouseLoss();
     ...
     * @return 报损总额
     */
    int getLossByTime(String beginDateStr, String endDateStr);
     ...
     * @return 赠送总额
     */
    int getPresentByTime(String beginDateStr, String endDateStr);
